...
const SECTIONS = [
  ...
  { num: '03', title: "What's still estimated", body: ['The tax-bracket label is a rough, zone-level estimate rather than a riding-specific measurement.'] },
    ...
    <main style={{ fontFamily: 'var(--font-body)', background: 'var(--color-bg)', minHeight: '100vh', color: 'var(--color-text-1)' }}>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: 'clamp(3rem,6vh,5rem) 2rem' }}>
        ...
        <p style={{ fontSize: 16, color: 'var(--color-text-2)', lineHeight: 1.7, maxWidth: 620, marginBottom: '3.5rem' }}>
          Boundaries, income, rent, represented party, population, and safety are real government data. Regional tax-bracket tiers are estimated.
        </p>
