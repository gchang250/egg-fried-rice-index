...
const SECTIONS = [
  { num: '01', title: 'What the index measures', body: ['The Fried Rice Index is built from restaurant menu data. It compares fried rice prices across cities and studies what those prices reveal about everyday affordability, local restaurant markets, and urban economic conditions.', "It is a narrower signal than CPI, PPP, rent data, or wage data: one common restaurant dish, transparent about what it is and what it isn't."] },
  ...
  { num: '10', title: 'Limitations', body: ["The index does not account for rent, wages, taxes, transportation, groceries, portion differences, service models, delivery markups, or exchange-rate changes. It's a narrow restaurant-price signal, and honest about that."] },
]
