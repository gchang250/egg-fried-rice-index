...
const cities = [
  {
    name: 'Vancouver', country: 'Canada', region: 'British Columbia', flag: '🇨🇦',
    priceCAD: 16.50, coord: [-123.12, 49.28],
    population: '675,000',
    climate: 'Oceanic — mild rainy winters, warm dry summers',
    blurb: 'Nestled between the Pacific Ocean and the Coast Mountains, Vancouver is one of Canada\'s most culturally diverse cities. A major gateway for Asian immigration, it has one of the largest Chinese-Canadian communities in the country and a thriving tech and film industry.'
  },
  {
    name: 'Toronto', country: 'Canada', region: 'Ontario', flag: '🇨🇦',
    priceCAD: 14.00, coord: [-79.38, 43.65],
    population: '2,930,000',
    climate: 'Humid continental — cold winters, hot humid summers',
    blurb: 'Canada\'s largest city and financial capital, Toronto is one of the most multicultural cities in the world. Over half its residents were born outside Canada. It is the top destination for new immigrants to Canada, with major communities from South Asia, China, the Philippines, and the Caribbean.'
  },
  {
    name: 'Montreal', country: 'Canada', region: 'Quebec', flag: '🇨🇦',
    priceCAD: 13.50, coord: [-73.57, 45.50],
    population: '1,780,000',
    climate: 'Humid continental — cold snowy winters, warm summers',
    blurb: 'The cultural capital of French Canada, Montreal blends European character with North American energy. It is known for its vibrant arts scene, world-class restaurants, and low cost of living relative to other major Canadian cities. A growing tech hub attracting immigrants from francophone Africa and Haiti.'
  },
  {
    name: 'Calgary', country: 'Canada', region: 'Alberta', flag: '🇨🇦',
    priceCAD: 13.00, coord: [-114.07, 51.04],
    population: '1,340,000',
    climate: 'Semi-arid — cold winters, warm summers, frequent chinooks',
    blurb: 'Built on oil wealth, Calgary has diversified into tech and finance. It has one of the youngest and fastest-growing populations of any major Canadian city, with a booming South Asian immigrant community. The city offers high wages and relatively affordable housing compared to Vancouver and Toronto.'
  },
  {
    name: 'Edmonton', country: 'Canada', region: 'Alberta', flag: '🇨🇦',
    priceCAD: 12.50, coord: [-113.49, 53.55],
    population: '1,010,000',
    climate: 'Humid continental/subarctic — long cold winters, short warm summers',
    blurb: 'Alberta\'s capital and the northernmost major city in Canada. Edmonton serves as the gateway to the oil sands and has a large Filipino community, one of the largest in Canada. It offers strong employment opportunities and a lower cost of living than most major Canadian cities.'
  },
  {
    name: 'New York', country: 'USA', region: 'New York State', flag: '🇺🇸',
    priceCAD: 19.00, coord: [-74.01, 40.71],
    population: '8,330,000',
    climate: 'Humid subtropical — hot summers, cold winters, year-round rain',
    blurb: 'The most populous city in the United States and a global financial, cultural, and media capital. New York has been the entry point for waves of immigrants for over a century. Today it is home to massive Chinese, Dominican, Mexican, Indian, and Korean communities among hundreds of others.'
  },
  {
    name: 'Los Angeles', country: 'USA', region: 'California', flag: '🇺🇸',
    priceCAD: 17.50, coord: [-118.24, 34.05],
    population: '3,980,000',
    climate: 'Mediterranean — warm dry summers, mild wet winters',
    blurb: 'The entertainment capital of the world and a major Pacific Rim gateway. Los Angeles has one of the largest Korean communities outside Korea, a massive Mexican-American population, and significant Chinese, Filipino, and Vietnamese communities. Its economy spans entertainment, tech, trade, and aerospace.'
  },
  {
    name: 'Chicago', country: 'USA', region: 'Illinois', flag: '🇺🇸',
    priceCAD: 16.00, coord: [-87.63, 41.88],
    population: '2,700,000',
    climate: 'Humid continental — cold windy winters, hot summers',
    blurb: 'The Midwest\'s largest city and a major hub for finance, manufacturing, and transportation. Chicago has a storied immigrant history, from early waves of Polish and Italian arrivals to today\'s large Mexican, Indian, and Chinese communities. Known as the city that shaped American blues, jazz, and architecture.'
  },
  {
    name: 'Houston', country: 'USA', region: 'Texas', flag: '🇺🇸',
    priceCAD: 11.50, coord: [-95.37, 29.76],
    population: '2,300,000',
    climate: 'Humid subtropical — hot summers, mild winters, frequent storms',
    blurb: 'The energy capital of the world and one of the most ethnically diverse cities in the United States. Houston\'s low cost of living, lack of state income tax, and booming economy have made it a magnet for immigrants from Latin America, Asia, and Africa. It has the largest Vietnamese community in the southern US.'
  },
  {
    name: 'Phoenix', country: 'USA', region: 'Arizona', flag: '🇺🇸',
    priceCAD: 12.00, coord: [-112.07, 33.45],
    population: '1,620,000',
    climate: 'Hot desert — extremely hot summers, mild winters, very little rain',
    blurb: 'One of the fastest-growing cities in the United States. Phoenix has a large Hispanic population and a growing South Asian tech community driven by the expansion of the semiconductor industry in the region. Its affordability relative to coastal cities has driven significant domestic and international migration.'
  },
  {
    name: 'Philadelphia', country: 'USA', region: 'Pennsylvania', flag: '🇺🇸',
    priceCAD: 15.50, coord: [-75.17, 39.95],
    population: '1,570,000',
    climate: 'Humid subtropical — hot summers, cold winters, moderate rainfall',
    blurb: 'One of America\'s oldest and most historically significant cities, birthplace of the US Declaration of Independence. Philadelphia has a large Black American community and growing immigrant populations from China, Mexico, India, and Vietnam. It is known for its world-class universities, hospitals, and affordable housing relative to nearby New York.'
  },
]

const rates: Record<string, number> = {
  CAD: 1, USD: 0.73, EUR: 0.68, CHF: 0.66, GBP: 0.58,
  JPY: 107.5, CNY: 5.30, AUD: 1.13, HKD: 5.72, SGD: 0.99,
  SAR: 2.74, PHP: 41.2, MYR: 3.18, MXN: 14.6, ARS: 720.0,
  KRW: 1001.0, INR: 60.8, AED: 2.68,
}
const symbols: Record<string, string> = {
  CAD: 'CA$', USD: 'US$', EUR: '€', CHF: 'Fr', GBP: '£',
  JPY: '¥', CNY: '¥', AUD: 'AU$', HKD: 'HK$', SGD: 'S$',
  SAR: '﷼', PHP: '₱', MYR: 'RM', MXN: 'MX$', ARS: 'AR$',
  KRW: '₩', INR: '₹', AED: 'د.إ',
}
...
const formatDate = (dateString: string | null | undefined) => {
  ...
  const fetchCities = async () => {
    ...
    if (data) {
      ...
      data.forEach((row: any) => { mapped[row.city] = row })
      setDbCities(mapped)
    }
    setDbLoading(false)
  }
...
const displayCities: City[] = cities.map(city => {
  ...
  useEffect(() => {
    ...
    d3.json('https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json').then((world: any) => {
      ...
      displayCities.forEach(city => {
        const [x, y] = projection(city.coord as [number, number])!
  ...
  const sectionLabel: React.CSSProperties = {
    ...
    textTransform: 'uppercase', color: '#9b9b90', marginBottom: 4
  }
  const divider: React.CSSProperties = {
    borderBottom: '0.5px solid #f0ede6', margin: '1rem 0'
  }
  ...
  return (
    <main style={{ fontFamily: 'DM Sans, sans-serif', background: '#FAFAF8', minHeight: '100vh', color: '#1a1a18' }}>
      ...
      {/* Backdrop */}
      {selectedCity && (
        <div onClick={handleClose} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.15)', zIndex: 99 }} />
      )}
          ...
          <>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
              <div>
                ...
                <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 28, letterSpacing: -0.5, margin: 0 }}>{selectedCity.name}</h2>
              </div>
              <button onClick={handleClose} style={{ background: 'none', border: '0.5px solid #e5e3da', borderRadius: 8, padding: '6px 10px', cursor: 'pointer', fontSize: 13, color: '#6b6b64', fontFamily: 'DM Sans, sans-serif' }}>
                Close
              </button>
            </div>
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <p style={{ fontSize: 14, color: '#1a1a18', lineHeight: 1.5 }}>{selectedCity.region}, {selectedCity.country}</p>
            </div>

            <div style={divider} />
            <div style={{ marginBottom: '1rem' }}>
              <p style={sectionLabel}>Population</p>
              <p style={{ fontSize: 14, color: '#1a1a18', lineHeight: 1.5 }}>{selectedCity.population}</p>
            </div>

            <div style={divider} />
            <div style={{ marginBottom: '1rem' }}>
              <p style={sectionLabel}>Climate</p>
              <p style={{ fontSize: 14, color: '#1a1a18', lineHeight: 1.5 }}>{selectedCity.climate}</p>
            </div>
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <p style={{ fontFamily: 'DM Serif Display, serif', fontSize: 32, color: '#C25E1E', margin: 0 }}>
              ...
              <div style={{ marginTop: '0.8rem', fontSize: 12, color: '#6b6b64', lineHeight: 1.6 }}>
                <p style={{ margin: 0 }}>
                ...
                <p style={{ margin: 0 }}>
                  ...
                  {selectedCity.confidenceScore !== null && selectedCity.confidenceScore !== undefined
            ...
            <div>
              ...
              <p style={{ fontSize: 14, color: '#3a3a34', lineHeight: 1.7 }}>{selectedCity.blurb}</p>
            </div>
          </>
        )}
      </div>
      ...
      {/* Main content */}
        ...
        <div style={{ background: '#fff', border: '0.5px solid #e5e3da', borderRadius: 16, padding: '1.5rem', overflow: 'hidden', opacity: expanded ? 0 : 1, transition: 'opacity 0.2s' }}>
          ...
          <select
            ...
            style={{ width: '100%', padding: '0.6rem 1rem', border: '0.5px solid #e5e3da', borderRadius: 10, background: '#FAFAF8', fontFamily: 'DM Sans, sans-serif', fontSize: 13, color: '#1a1a18', marginBottom: '1.1rem' }}
          >
        ...
        <div style={{ background: '#fff', border: '0.5px solid #e5e3da', borderRadius: 16, padding: '1.5rem' }}>
          <div style={{
            ...
            <p style={{ fontSize: 11, fontWeight: 500, letterSpacing: '1.2px', textTransform: 'uppercase', color: '#9b9b90', margin: 0 }}>Map</p>
              ...
              <button onClick={() => setExpanded(!expanded)} style={{ background: 'none', border: '0.5px solid #e5e3da', borderRadius: 8, padding: '5px 10px', cursor: 'pointer', fontSize: 12, color: '#6b6b64', fontFamily: 'DM Sans, sans-serif' }}>
          ...
          <p style={{ fontSize: 11, color: '#9b9b90', marginTop: 8 }}>Scroll to zoom · drag to pan · click a city for details</p>
        </div>
      </div>
    </main>
  )
